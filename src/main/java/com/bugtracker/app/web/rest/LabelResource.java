...
import com.bugtracker.app.domain.Label;
import com.bugtracker.app.repository.LabelRepository;
...
/**
 * REST controller for managing {@link com.bugtracker.app.domain.Label}.
 */
@RestController
@RequestMapping("/api")
@Transactional
